                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                    <div className="order-2 lg:order-1">
                        ...
                        <p className="text-gray-700 text-base sm:text-lg mb-2 leading-relaxed ">
                            Impulsamos negocios desde Perú hacia toda la región. Nuestra tecnología ya opera con éxito en Ecuador, Argentina, Colombia y Guatemala, como parte de un plan de expansión constante que busca llevar la eficiencia, innovación y confiabilidad de Select Technology a cada rincón de Latinoamérica y el mundo.
                        </p>
