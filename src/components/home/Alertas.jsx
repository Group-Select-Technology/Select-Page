...
const AlertaCard = ({ titulo, descripcion, icono }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute inset-0 bg-[#17359d] flex flex-col items-center justify-center gap-3 px-5 py-4 transition-all duration-300 ${
      ...
      >
        ...
        <p className="text-white/90 text-md text-center font-bold">
          {descripcion}
        </p>
      </div>
    </div>
